...
const is_docker_1 = (0, tslib_1.__importDefault)(require("is-docker"));
...
exports.default = (path = core_1.SfdxProject.resolveProjectPathSync()) => {
    ...
    const config = {
        ...
        puppeteer: configFromFile.puppeteer || ((0, is_docker_1.default)() && defaults.puppeteerDocker) || defaults.puppeteer,
    };
