...
const puppeteer2_1 = require("../../../../utils/puppeteer2");
...
class ImportState extends command_1.SfdxCommand {
    async run() {
        ...
        const taskRunner = new puppeteer2_1.PuppeteerTasks2({
                    ...
                    ctx.data.add.forEach((el) => {
                        addTasks.push({
                            ...
                            task: async (ctx, task) => {
                                ...
                                ctx.result.push(Object.assign(Object.assign({}, el), { status: result }));
                                if (result === 'skipped') {
                                    task.skip();
                                }
                            },
