            ...
            if (Object.keys(jsonParsed).includes(this.flags.category)) {
                ...
                if (config.deactivate[this.flags.countrycode.toUpperCase()]) {
                    if (config.deactivate[this.flags.countrycode.toUpperCase()][this.flags.category]) {
                        ...
                        try {
                            for (var _c = __asyncValues(config.deactivate[this.flags.countrycode.toUpperCase()][this.flags.category]), _d; _d = await _c.next(), !_d.done;) {
                ...
                try {
                    ...
                    for (var _e = __asyncValues(jsonParsed[this.flags.category]), _f; _f = await _e.next(), !_f.done;) {
