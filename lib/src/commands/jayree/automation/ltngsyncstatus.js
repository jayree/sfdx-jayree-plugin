...
const messages = command_1.core.Messages.loadMessages('sfdx-jayree', 'ltngsyncstatus');
class UserSyncStatus extends command_1.SfdxCommand {
  async run() {
...
UserSyncStatus.description = messages.getMessage('commandDescription');
UserSyncStatus.examples = [
...
UserSyncStatus.requiresUsername = true;
UserSyncStatus.supportsDevhubUsername = false;
UserSyncStatus.requiresProject = false;
exports.default = UserSyncStatus;
//# sourceMappingURL=ltngsyncstatus.js.map
