...
class ScratchOrgSettings extends command_1.SfdxCommand {
    async run() {
        ...
        let settings = {};
        try {
            for (var settingsarray_1 = __asyncValues(settingsarray), settingsarray_1_1; settingsarray_1_1 = await settingsarray_1.next(), !settingsarray_1_1.done;) {
                ...
                try {
                    ...
                    if (typeof settingsQuery.records !== 'undefined') {
                        try {
                            for (var _c = __asyncValues(settingsQuery.records), _d; _d = await _c.next(), !_d.done;) {
