...
class ScratchOrgRevisionInfo extends command_1.SfdxCommand {
    async run() {
        ...
        const storedmaxrevpath = await (0, stateFolderHandler_1.getCurrentStateFolderFilePath)(this.project.getPath(), path.join('orgs', this.org.getOrgId(), 'jayreeStoredMaxRevision.json'), true);
