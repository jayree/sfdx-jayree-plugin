...
class RetrieveProfiles extends sourceRetrieveBase_1.SourceRetrieveBase {
    async run() {
        ...
        try {
            ...
            out = json(shell.exec(`sfdx force:source:retrieve --manifest=${packagexml} --targetusername=${this.org.getUsername()} --json`, {
                cwd: orgretrievepath,
                fatal: false,
                silent: true,
            ...
            if (((_a = out === null || out === void 0 ? void 0 : out.inboundFiles) === null || _a === void 0 ? void 0 : _a.length) > 0) {
                ...
                if (this.flags.metadata.includes('PermissionSet')) {
                    inboundFiles.push(...out.inboundFiles.filter((x) => x.filePath.includes('force-app/main/default/permissionsets')));
                }
