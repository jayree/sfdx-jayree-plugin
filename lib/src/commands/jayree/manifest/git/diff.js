                        ...
                        task: (ctx, task) => task.newListr([
                            {
                                ...
                                // eslint-disable-next-line @typescript-eslint/no-shadow
                                task: (ctx, task) => {
                                    ctx.destructiveChangesComponentSet = (0, gitdiff_1.createManifest)(ctx.ref1VirtualTreeContainer, true, ctx.gitResults, task);
                                },
                                options: {
                                    bottomBar: 5,
                        ...
                        task: (ctx, task) => task.newListr([
                            {
                                ...
                                // eslint-disable-next-line @typescript-eslint/no-shadow
                                task: (ctx, task) => {
                                    ctx.manifestComponentSet = (0, gitdiff_1.createManifest)(ctx.ref2VirtualTreeContainer, false, ctx.gitResults, task);
                                },
                                options: {
                                    bottomBar: 5,
                                    persistentOutput: true,
