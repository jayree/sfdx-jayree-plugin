...
<Package xmlns="http://soap.sforce.com/2006/04/metadata">
  <version>${ctx.sfdxProject.sourceApiVersion}</version>
                    ...
                    },
                    {
                        ...
                        // eslint-disable-next-line @typescript-eslint/no-shadow
                        task: async (ctx) => {
                            ctx.destructiveChanges.content = await gitdiff_1.appendToManifest(ctx.destructiveChangesManifestFile, ctx.gitResults.modified.toDestructiveChanges, { destruct: true });
                        },
                    },
                    {
                        title: 'Save',
