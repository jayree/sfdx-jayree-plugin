        ...
        try {
            ...
            try {
                for (var folders_1 = tslib_1.__asyncValues(folders), folders_1_1; folders_1_1 = await folders_1.next(), !folders_1_1.done;) {
                    ...
                    try {
                        for (var folderItems_1 = tslib_1.__asyncValues(folderItems), folderItems_1_1; folderItems_1_1 = await folderItems_1.next(), !folderItems_1_1.done;) {
...
GeneratePackageXML.aliases = ['jayree:manifest:generate'];
