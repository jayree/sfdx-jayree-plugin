  ...
  async run() {
    ...
    for (let retries = 0; ; retries++) {
      try {
        ...
        try {
          for (
            var folders_1 = __asyncValues(folders), folders_1_1;
            (folders_1_1 = await folders_1.next()), !folders_1_1.done;
            ...
            try {
              for (
                var folderItems_1 = __asyncValues(folderItems), folderItems_1_1;
                (folderItems_1_1 = await folderItems_1.next()), !folderItems_1_1.done;
                ...
                if (typeof folderItem !== 'undefined') {
                  ...
                  const promise = this.listMetaData(
                    conn,
                    { type: objectType, folder: folderItem.fullName },
                    apiVersion
                  );
              ...
              try {
                if (folderItems_1_1 && !folderItems_1_1.done && (_c = folderItems_1.return))
                  await _c.call(folderItems_1);
              } finally {
