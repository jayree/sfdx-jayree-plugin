...
describe('platform.win32', () => {
    ...
    test_1.test
        ...
        (0, test_1.expect)(ctx.stdout).to.contain('test@org.com');
    });
    test_1.test
        .withOrg({ username: 'test@org.com' }, true)
        .stdout()
        ...
        (0, test_1.expect)(ctx.stdout).to.contain('firefox');
    });
    test_1.test
        .withOrg({ username: 'test@org.com' }, true)
        .stderr()
        ...
        (0, test_1.expect)(ctx.stderr).to.contain('not supported');
    });
    test_1.test
        .withOrg({ username: 'test@org.com' }, true)
        .stdout()
        ...
        (0, test_1.expect)(ctx.stdout).to.contain('lightning');
    });
});
...
describe('platform.darwin', () => {
    ...
    test_1.test
        ...
        .command(['jayree:org:open', '--targetusername', 'test@org.com', '-r', '-b', 'safari'])
        .it('runs jayree:org:open --targetusername test@org.com -r -b safari', (ctx) => {
        (0, test_1.expect)(ctx.stdout).to.contain('safari');
    });
    test_1.test
        .withOrg({ username: 'test@org.com' }, true)
        .stdout()
