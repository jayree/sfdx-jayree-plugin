    ...
    beforeEach(() => {
        ...
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'listMetaData').callsFake(async () => {
            return Promise.resolve([
                Object.assign({}, createdlastModifiedfields, { fileName: 'flows/testflow.flow', fullName: 'testflow', id: flowid, manageableState: 'unmanaged', type: 'Flow' })
            ]);
        });
...
describe('Installed Packages', () => {
    beforeEach(() => {
        ...
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'listMetaData').callsFake(async () => {
            return Promise.resolve([
                Object.assign({}, createdlastModifiedfields, { fileName: 'installedPackages/sf_chttr_apps.installedPackage', fullName: 'sf_chttr_apps', id: _uniqid(), namespacePrefix: 'sf_chttr_apps', type: 'InstalledPackage' }),
                Object.assign({}, createdlastModifiedfields, { fileName: 'labels/CustomLabels.labels', fullName: 'customlabelname', id: _uniqid(), manageableState: 'installed', namespacePrefix: 'mypackage', type: 'CustomLabel' })
            ]);
        });
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'toolingQuery').callsFake(async () => {
            return new Promise((resolve, reject) => {
...
describe('Exclude Installed Packages', () => {
    beforeEach(() => {
        ...
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'listMetaData').callsFake(async () => {
            return Promise.resolve([
                Object.assign({}, createdlastModifiedfields, { fileName: 'installedPackages/sf_chttr_apps.installedPackage', fullName: 'sf_chttr_apps', id: _uniqid(), namespacePrefix: 'sf_chttr_apps', type: 'InstalledPackage' }),
                Object.assign({}, createdlastModifiedfields, { fileName: 'labels/CustomLabels.labels', fullName: 'customlabelname', id: _uniqid(), manageableState: 'installed', type: 'CustomLabel' }),
                Object.assign({}, createdlastModifiedfields, { fileName: 'reports/testreports/testreport.report', fullName: 'testreports/testreport', id: _uniqid(), manageableState: 'unmanaged', type: 'Report' })
            ]);
        });
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'toolingQuery').callsFake(async () => {
            return new Promise((resolve, reject) => {
...
describe('ValueSetTranslations', () => {
    beforeEach(() => {
        ...
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'listMetaData').callsFake(async () => {
            return Promise.resolve([
                Object.assign({}, createdlastModifiedfields, { fileName: 'globalValueSetTranslations/testvalueset1-xx.globalValueSetTranslation', fullName: 'testvalueset1-xx', id: '', namespacePrefix: '', type: { $: { 'xsi:nil': 'true' } } }),
                Object.assign({}, createdlastModifiedfields, { fileName: 'globalValueSetTranslations/testvalueset2-xx.globalValueSetTranslation', fullName: 'testvalueset2-xx', id: '', namespacePrefix: '', type: { $: { 'xsi:nil': 'true' } } })
            ]);
        });
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'toolingQuery').callsFake(async () => {
            return new Promise((resolve, reject) => {
...
describe('Foldered Objects', () => {
    beforeEach(() => {
        ...
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'listMetaData')
            ...
            .callsFake(async () => {
            return Promise.resolve([
                Object.assign({}, createdlastModifiedfields, { fileName: 'email/emailtestfolder', fullName: 'emailtestfolder', id: _uniqid(), manageableState: 'installed', namespacePrefix: 'mypackage', type: 'EmailFolder' })
            ]);
        })
            .onCall(1)
            .callsFake(async () => {
            return Promise.resolve([
                Object.assign({}, createdlastModifiedfields, { fileName: 'email/emailtestfolder/test1.email', fullName: 'emailtestfolder/test1', id: _uniqid(), manageableState: 'installed', namespacePrefix: 'emailtest', type: 'EmailTemplate' })
            ]);
        });
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'toolingQuery').callsFake(async () => {
            return new Promise((resolve, reject) => {
...
describe('Foldered Objects - Single Object', () => {
    beforeEach(() => {
        ...
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'listMetaData')
            ...
            .callsFake(async () => {
            return new Promise((resolve, reject) => {
                resolve(Object.assign({}, createdlastModifiedfields, { fileName: 'reports/testreportfolder', fullName: 'testreportfolder', id: _uniqid(), manageableState: 'unmanaged', type: 'ReportFolder' }));
            });
        })
            .onCall(1)
            .callsFake(async () => {
            return new Promise((resolve, reject) => {
                resolve(Object.assign({}, createdlastModifiedfields, { fileName: 'reports/testreportfolder/testreport.report', fullName: 'testreportfolder/testreport', id: _uniqid(), manageableState: 'unmanaged', type: 'Report' }));
            });
        });
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'toolingQuery').callsFake(async () => {
            return new Promise((resolve, reject) => {
...
describe('Unfoldered Objects', () => {
    beforeEach(() => {
        ...
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'listMetaData').callsFake(async () => {
            return Promise.resolve([
                Object.assign({}, createdlastModifiedfields, { fileName: 'labels/CustomLabels.labels', fullName: 'CustomLabels', id: '', namespacePrefix: '', type: 'CustomLabels' }),
                Object.assign({}, createdlastModifiedfields, { fileName: 'labels/CustomLabels.labels', fullName: 'customlabelname', id: _uniqid(), manageableState: 'installed', type: 'CustomLabel' })
            ]);
        });
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'toolingQuery').callsFake(async () => {
...
describe('Unfoldered Objects - single  Object', () => {
    beforeEach(() => {
        ...
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'listMetaData').callsFake(async () => {
            return new Promise((resolve, reject) => {
                resolve(Object.assign({}, createdlastModifiedfields, { fileName: 'labels/CustomLabels.labels', fullName: 'CustomLabels', id: '', namespacePrefix: '', type: 'CustomLabels' }));
            });
        });
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'toolingQuery').callsFake(async () => {
            return new Promise((resolve, reject) => {
