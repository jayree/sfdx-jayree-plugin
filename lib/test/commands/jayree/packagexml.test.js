...
describe('Installed Packages', () => {
    beforeEach(() => {
        ...
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'listMetaData').callsFake(async () => {
            return Promise.resolve([
                Object.assign(Object.assign({}, createdlastModifiedfields), { fileName: 'installedPackages/sf_chttr_apps.installedPackage', fullName: 'sf_chttr_apps', id: uniqid(), namespacePrefix: 'sf_chttr_apps', type: 'InstalledPackage' }),
                Object.assign(Object.assign({}, createdlastModifiedfields), { fileName: 'labels/CustomLabels.labels', fullName: 'customlabelname', id: uniqid(), manageableState: 'installed', namespacePrefix: 'mypackage', type: 'CustomLabel' }),
            ]);
        });
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'toolingQuery').callsFake(async () => {
            return new Promise((resolve) => {
...
describe('Exclude Installed Packages', () => {
    beforeEach(() => {
        ...
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'listMetaData').callsFake(async () => {
            return Promise.resolve([
                Object.assign(Object.assign({}, createdlastModifiedfields), { fileName: 'installedPackages/sf_chttr_apps.installedPackage', fullName: 'sf_chttr_apps', id: uniqid(), namespacePrefix: 'sf_chttr_apps', type: 'InstalledPackage' }),
                Object.assign(Object.assign({}, createdlastModifiedfields), { fileName: 'labels/CustomLabels.labels', fullName: 'customlabelname', id: uniqid(), manageableState: 'installed', type: 'CustomLabel' }),
                Object.assign(Object.assign({}, createdlastModifiedfields), { fileName: 'reports/testreports/testreport.report', fullName: 'testreports/testreport', id: uniqid(), manageableState: 'unmanaged', type: 'Report' }),
            ]);
        });
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'toolingQuery').callsFake(async () => {
            return new Promise((resolve) => {
...
describe('Foldered Objects', () => {
    beforeEach(() => {
        ...
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'listMetaData')
            ...
            .callsFake(async () => {
            return Promise.resolve([
                Object.assign(Object.assign({}, createdlastModifiedfields), { fileName: 'email/emailtestfolder', fullName: 'emailtestfolder', id: uniqid(), manageableState: 'installed', namespacePrefix: 'mypackage', type: 'EmailFolder' }),
            ]);
        })
            .onCall(1)
            .callsFake(async () => {
            return Promise.resolve([
                Object.assign(Object.assign({}, createdlastModifiedfields), { fileName: 'email/emailtestfolder/test1.email', fullName: 'emailtestfolder/test1', id: uniqid(), manageableState: 'installed', namespacePrefix: 'emailtest', type: 'EmailTemplate' }),
            ]);
        });
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'toolingQuery').callsFake(async () => {
            return new Promise((resolve) => {
...
describe('Foldered Objects - Single Object', () => {
    beforeEach(() => {
        ...
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'listMetaData')
            ...
            .callsFake(async () => {
            return new Promise((resolve) => {
                resolve(Object.assign(Object.assign({}, createdlastModifiedfields), { fileName: 'reports/testreportfolder', fullName: 'testreportfolder', id: uniqid(), manageableState: 'unmanaged', type: 'ReportFolder' }));
            });
        })
            .onCall(1)
            .callsFake(async () => {
            return new Promise((resolve) => {
                resolve(Object.assign(Object.assign({}, createdlastModifiedfields), { fileName: 'reports/testreportfolder/testreport.report', fullName: 'testreportfolder/testreport', id: uniqid(), manageableState: 'unmanaged', type: 'Report' }));
            });
        });
        test_1.$$.SANDBOX.stub(packagexml.default.prototype, 'toolingQuery').callsFake(async () => {
            return new Promise((resolve) => {
