...
const packagexml = (0, tslib_1.__importStar)(require("../../../src/commands/jayree/manifest/generate"));
const uniqid = () => {
...
describe('Flow with ActiveVersion <> LatestVersion', () => {
    ...
    test_1.test
        ...
        (0, test_1.expect)(ctx.stdout).to.contain('<members>testflow-1</members>');
        (0, test_1.expect)(ctx.stdout).to.contain('<version>43.0</version>');
        (0, test_1.expect)(ctx.stderr).to.contain("WARNING: Flow: ActiveVersion (1) for 'testflow' found - changing 'testflow' to 'testflow-1'");
    });
    test_1.test
        .stdout()
        .stderr()
        ...
        (0, test_1.expect)(ctx.stdout).to.contain('<members>testflow</members>');
        (0, test_1.expect)(ctx.stdout).to.contain('<version>44.0</version>');
        (0, test_1.expect)(ctx.stderr).to.contain("WARNING: Flow: ActiveVersion (1) differs from LatestVersion (2) for 'testflow' - you will retrieve LatestVersion (2)!");
    });
});
describe('Flow with ActiveVersion = LatestVersion', () => {
    beforeEach(() => {
    ...
    test_1.test
        ...
        (0, test_1.expect)(ctx.stdout).to.contain('<members>testflow</members>');
        (0, test_1.expect)(ctx.stdout).to.contain('<version>44.0</version>');
        (0, test_1.expect)(ctx.stderr).to.not.contain("WARNING: Flow: ActiveVersion (1) differs from LatestVersion (2) for 'testflow' - you will retrieve LatestVersion (2)!");
    });
});
...
describe('ConfigFile without any parameters', () => {
    ...
    test_1.test
        ...
        .it('runs jayree:packagexml --targetusername test@org.com --configfile=test/assets/config.json', (ctx) => {
        (0, test_1.expect)(ctx.stdout).to.contain('<version>42.0</version>');
    });
});
...
describe('ConfigFile does not exist', () => {
    ...
    test_1.test
        ...
        (0, test_1.expect)(ctx.stderr).to.contain('ENOENT: no such file or directory');
    });
});
describe('Installed Packages', () => {
    ...
    test_1.test
        ...
        (0, test_1.expect)(ctx.stdout).to.contain('<members>customlabelname</members>');
        (0, test_1.expect)(ctx.stdout).to.contain('<name>CustomLabel</name>');
    });
});
describe('Exclude Installed Packages', () => {
    ...
    test_1.test
        ...
        .it('runs jayree:packagexml --targetusername test@org.com', (ctx) => {
        (0, test_1.expect)(ctx.stdout).to.contain('<name>Report</name>');
        (0, test_1.expect)(ctx.stdout).to.not.contain('<name>CustomLabel</name>');
        (0, test_1.expect)(ctx.stdout).to.not.contain('<members>sf_chttr_apps</members>');
    });
});
describe('ValueSetTranslations', () => {
    ...
    test_1.test
        ...
        .command(['jayree:packagexml', '--targetusername', 'test@org.com'])
        .it('runs jayree:packagexml --targetusername test@org.com', (ctx) => {
        (0, test_1.expect)(ctx.stdout).to.contain('<name>GlobalValueSetTranslation</name>');
        (0, test_1.expect)(ctx.stdout).to.contain('<members>testvalueset1-xx</members>');
        (0, test_1.expect)(ctx.stdout).to.contain('<members>testvalueset2-xx</members>');
    });
});
describe('Foldered Objects', () => {
    ...
    test_1.test
        ...
        .command(['jayree:packagexml', '--targetusername', 'test@org.com'])
        .it('runs jayree:packagexml --targetusername test@org.com', (ctx) => {
        (0, test_1.expect)(ctx.stdout).to.contain('<name>EmailTemplate</name>');
        (0, test_1.expect)(ctx.stdout).to.contain('<members>emailtestfolder/test1</members>');
    });
});
describe('Foldered Objects - Single Object', () => {
    ...
    test_1.test
        ...
        .it('runs jayree:packagexml --targetusername test@org.com', (ctx) => {
        (0, test_1.expect)(ctx.stdout).to.contain('<name>Report</name>');
        (0, test_1.expect)(ctx.stdout).to.contain('<members>testreportfolder/testreport</members>');
    });
});
describe('Foldered Objects - undefined', () => {
    ...
    test_1.test
        ...
        .command(['jayree:packagexml', '--targetusername', 'test@org.com'])
        .it('runs jayree:packagexml --targetusername test@org.com', (ctx) => {
        (0, test_1.expect)(ctx.stdout).to.not.contain('<name>Report</name>');
        (0, test_1.expect)(ctx.stdout).to.not.contain('<members>testreportfolder/testreport</members>');
    });
});
describe('Unfoldered Objects', () => {
    ...
    test_1.test
        ...
        .command(['jayree:packagexml', '--targetusername', 'test@org.com'])
        .it('runs jayree:packagexml --targetusername test@org.com', (ctx) => {
        (0, test_1.expect)(ctx.stdout).to.contain('<name>CustomLabels</name>');
        (0, test_1.expect)(ctx.stdout).to.contain('<members>CustomLabels</members>');
        (0, test_1.expect)(ctx.stdout).to.contain('<members>customlabelname</members>');
        (0, test_1.expect)(ctx.stdout).to.contain('<name>CustomLabel</name>');
    });
});
...
describe('QuickFilter', () => {
    ...
    test_1.test
        ...
        (0, test_1.expect)(ctx.stdout).to.contain('<name>CustomLabel</name>');
        (0, test_1.expect)(ctx.stdout).to.contain('<members>customlabelname</members>');
        (0, test_1.expect)(ctx.stdout).to.not.contain('<name>CustomLabels</name>');
    });
    test_1.test
        .stdout()
        .stderr()
...
describe('Write File', () => {
    ...
    test_1.test
        ...
        (0, test_1.expect)(ctx.stderr).to.contain('Generating test/assets/test.xml');
    });
});
describe('Write File - Error', () => {
    ...
    test_1.test
        ...
        .command(['jayree:packagexml', '--targetusername', 'test@org.com', '-f', 'test/assets/test.xml'])
        .it('runs jayree:packagexml --targetusername test@org.com -f test/assets/test.xml', (ctx) => {
        (0, test_1.expect)(ctx.stderr).to.contain('EACCES: permission denied');
    });
});
describe('Unfoldered Objects - Error', () => {
    ...
    test_1.test
        ...
        .command(['jayree:packagexml', '--targetusername', 'test@org.com'])
        .it('runs jayree:packagexml --targetusername test@org.com', (ctx) => {
        (0, test_1.expect)(ctx.stderr).to.contain('metadataObjects');
        (0, test_1.expect)(ctx.stderr).to.contain('Cannot read');
        (0, test_1.expect)(ctx.stderr).to.contain('null');
    });
});
describe('test valid standardValueSet', () => {
    ...
    test_1.test
        ...
        .command(['jayree:packagexml', '--targetusername', 'test@org.com'])
        .it('runs jayree:packagexml --targetusername test@org.com', (ctx) => {
        (0, test_1.expect)(ctx.stdout).to.contain('AccountContactMultiRoles');
    });
});
describe('test invalid standardValueSet', () => {
    ...
    test_1.test
        ...
        .command(['jayree:packagexml', '--targetusername', 'test@org.com'])
        .it('runs jayree:packagexml --targetusername test@org.com', (ctx) => {
        (0, test_1.expect)(ctx.stdout).to.not.contain('AccountContactMultiRoles');
    });
});
