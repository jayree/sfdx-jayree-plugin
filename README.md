...
## `sfdx jayree:automation:statecountry:create --countrycode <string> --category <string> --language <string> [--uselocalvariant] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

import (create/update) State/Country Picklists (beta)

```
USAGE
  $ sfdx jayree:automation:statecountry:create --countrycode <string> --category <string> --language <string> 
