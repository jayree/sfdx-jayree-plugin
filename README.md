...
_See code: [src/commands/jayree/source/retrieve/full.ts](https://github.com/jayree/sfdx-jayree-plugin/blob/v1.5.2/src/commands/jayree/source/retrieve/full.ts)_
<!-- commandsstop -->
