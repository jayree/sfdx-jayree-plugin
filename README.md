...
_See code: [src/commands/jayree/scratchorg/settings.ts](https://github.com/jayree/sfdx-jayree-plugin/blob/v1.1.1/src/commands/jayree/scratchorg/settings.ts)_
<!-- commandsstop -->
